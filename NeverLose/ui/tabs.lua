...
function Tabs.CreateTab(name, icon, order, Storage, Theme)
	...
	tabBtn.MouseButton1Click:Connect(function()
		...
		for n, d in pairs(Storage.tabButtons) do
			...
			TweenService:Create(d.icon,  TweenInfo.new(0.2), {TextColor3 = a and curT.Accent      or curT.TextDim}):Play()
			TweenService:Create(d.label, TweenInfo.new(0.2), {TextColor3 = a and curT.TextPrimary or curT.TextSecondary}):Play()
		end
